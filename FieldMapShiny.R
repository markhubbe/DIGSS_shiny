#' Field Map - SHINY VERSION
#'
#' Creates randomly placed ellipsoid sites in a rectangular field.
#'
#' @details `fieldMapShiny` creates and plots randomly placed ellipses representing
...
fieldMapShiny<-function(Area,site.density,site.area,overlap=0.50,plot=FALSE,areaprecision=1000){
